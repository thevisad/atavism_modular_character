...
namespace Atavism
{
    ...
    class ModularCustomizationManagerEditor : Editor
    {
        ...
        SerializedProperty modularBonedModelSwapping;
        ...
        SerializedProperty defaultHead;
        SerializedProperty defaultHips;
        SerializedProperty defaultLowerLegs;
        SerializedProperty defaultUpperArms;
        SerializedProperty defaultLowerArms;

        SerializedProperty colorSkinParamName ;
        SerializedProperty colorStubbleParamName ;
        SerializedProperty colorBodyArtParamName;
        SerializedProperty colorColor2ParamName;
        SerializedProperty colorHairParamName;
        SerializedProperty colorMouthParamName;
        SerializedProperty colorScarParamName;
        SerializedProperty colorEyesParamName;
        SerializedProperty colorPrimaryParamName;
        SerializedProperty colorSecondaryParamName;
        SerializedProperty colorTertiaryParamName;
        SerializedProperty colorLeatherPrimaryParamName;
        SerializedProperty colorLeatherSecondaryParamName;
        SerializedProperty colorLeatherTertiaryParamName;
        SerializedProperty colorMetalPrimaryParamName;
        SerializedProperty colorMetalDarkParamName;

        SerializedProperty DiffuseColorName;
        ...
        private void OnEnable()
        {
            ...
            DiffuseColorName = thisScriptObject.FindProperty("DiffuseColorName");
            ColorName = thisScriptObject.FindProperty("ColorName");

            colorSkinParamName = thisScriptObject.FindProperty("colorSkinParamName");
            colorStubbleParamName = thisScriptObject.FindProperty("colorStubbleParamName");
            colorBodyArtParamName = thisScriptObject.FindProperty("colorBodyArtParamName");
            colorColor2ParamName = thisScriptObject.FindProperty("colorColor2ParamName");
            colorHairParamName = thisScriptObject.FindProperty("colorHairParamName");
            colorMouthParamName = thisScriptObject.FindProperty("colorMouthParamName");
            colorScarParamName = thisScriptObject.FindProperty("colorScarParamName");
            colorEyesParamName = thisScriptObject.FindProperty("colorEyesParamName");
            colorPrimaryParamName = thisScriptObject.FindProperty("colorPrimaryParamName");
            colorSecondaryParamName = thisScriptObject.FindProperty("colorSecondaryParamName");
            colorTertiaryParamName = thisScriptObject.FindProperty("colorTertiaryParamName");
            colorLeatherPrimaryParamName = thisScriptObject.FindProperty("colorLeatherPrimaryParamName");
            colorLeatherSecondaryParamName = thisScriptObject.FindProperty("colorLeatherSecondaryParamName");
            colorLeatherTertiaryParamName = thisScriptObject.FindProperty("colorLeatherTertiaryParamName");
            colorMetalPrimaryParamName = thisScriptObject.FindProperty("colorMetalPrimaryParamName");
            colorMetalDarkParamName = thisScriptObject.FindProperty("colorMetalDarkParamName");
            ...
            modularBonedModelSwapping = thisScriptObject.FindProperty("modularBonedModelSwapping");
            modularBonedModelSwapping = thisScriptObject.FindProperty("modularBonedModelSwapping");
            ...
            defaultHead = thisScriptObject.FindProperty("defaultHead");
            defaultHips = thisScriptObject.FindProperty("defaultHips");
            defaultLowerLegs = thisScriptObject.FindProperty("defaultLowerLegs");
            defaultUpperArms = thisScriptObject.FindProperty("defaultUpperArms");
            defaultLowerArms = thisScriptObject.FindProperty("defaultLowerArms");
        ...
        public override void OnInspectorGUI()
        {
            ...
            script.toolbarTop = GUILayout.Toolbar(script.toolbarTop,
                new string[] {"General", "Selection", "Replacement"});
            ...
            script.toolbarMiddle = GUILayout.Toolbar(script.toolbarMiddle,
                new string[] {"Skinned", "MorphShapes", "Default Parts"});
            switch (script.toolbarMiddle)
            {
                ...
                case 2:
                    ...
                    script.currentTab = "Default Parts";
                    break;
            }

            script.toolbarBottom = GUILayout.Toolbar(script.toolbarBottom,
                new string[] {"Directories", "Materials"});
            ...
            switch (script.currentTab)
            {
                ...
                case "Materials":
                    ...
                    EditorGUILayout.PropertyField(DiffuseColorName);
                ...
                case "Color Options":
                    ...
                    EditorGUILayout.PropertyField(colorSkinParamName);
                    EditorGUILayout.PropertyField(colorStubbleParamName);
                    EditorGUILayout.PropertyField(colorBodyArtParamName);
                    EditorGUILayout.PropertyField(colorColor2ParamName);
                    EditorGUILayout.PropertyField(colorHairParamName);
                    EditorGUILayout.PropertyField(colorMouthParamName);
                    EditorGUILayout.PropertyField(colorScarParamName);
                    EditorGUILayout.PropertyField(colorEyesParamName);
                    EditorGUILayout.PropertyField(colorPrimaryParamName);
                    EditorGUILayout.PropertyField(colorSecondaryParamName);
                    EditorGUILayout.PropertyField(colorTertiaryParamName);
                    EditorGUILayout.PropertyField(colorLeatherPrimaryParamName);
                    EditorGUILayout.PropertyField(colorLeatherSecondaryParamName);
                    EditorGUILayout.PropertyField(colorLeatherTertiaryParamName);
                    EditorGUILayout.PropertyField(colorMetalPrimaryParamName);
                    EditorGUILayout.PropertyField(colorMetalDarkParamName);
                ...
                case "General":
                    ...
                    HeaderBoxStyle.normal.textColor = Color.cyan;
                    HeaderBoxStyle.fontStyle = FontStyle.Bold;
                    HeaderBoxStyle.fontSize = boxStyle.fontSize + 1;
                    HeaderBoxStyle.alignment = TextAnchor.UpperLeft;


                    //GUILayout.BeginVertical("", boxStyle);
                    //  DamageType dt = obj.damageTypeColor[key];

                    HeaderContent = new GUIContent("Main Modular Character Slots");
                    EditorGUILayout.LabelField(HeaderContent);
                    content.tooltip = "Select Slot Name for field";
                    if (slots == null)
                    {
                    ...
                    content.tooltip = headSlot.tooltip;
                    int j = -1;
                    ...
                    content.tooltip = torsoSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = upperarmSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = lowerarmSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = handsSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = hipSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = upperlegSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = lowerlegSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = feetSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = parentSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = rootSlot.tooltip;
                    j = -1;
                    ...
                    HeaderContent = new GUIContent("Optional Modular Character Slots");
                    EditorGUILayout.LabelField(HeaderContent);



                    content = new GUIContent("Head Covering Slot");
                    content.tooltip = headCoveringSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = beardSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = eyebrowSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = earSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = eyeSlot.tooltip;
                    j = -1;
                    ...
                    content.tooltip = mouthSlot.tooltip;
                    j = -1;
                ...
                case "Skinned":
                    ...
                    EditorGUILayout.PropertyField(modularBonedModelSwapping);
                    ...
                    EditorGUILayout.PropertyField(defaultHead);
                    EditorGUILayout.PropertyField(defaultHips);
                    EditorGUILayout.PropertyField(defaultLowerLegs);
                    EditorGUILayout.PropertyField(defaultUpperArms);
                    EditorGUILayout.PropertyField(defaultLowerArms);
