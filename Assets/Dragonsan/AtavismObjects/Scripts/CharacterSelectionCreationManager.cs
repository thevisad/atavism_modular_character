...
namespace Atavism
{
    ...
    public class CharacterSelectionCreationManager : MonoBehaviour
    {
      ...
      //  public Texture cursorOverride;
        ...
        public ModularCharacterDnaPanel modularCharacterDnaPanel;
        public ModularCharacterDnaPanel modularCharacterHeadDnaPanel;
        protected GameObject character;
        protected GameObject characterDCS;
        private MorphShapesManager morphShapesManager;
        ...
        public Color defaultButtonTextColor = Color.white;
        public Color selectedButtonTextColor = Color.green;
        ...
        public virtual void ModularCustomizationManagerCheck()
        {
            ...
            if (character && modularCustomizationManager)
            {
                ...
                if (characterSelected.ContainsKey(modularCustomizationManager.blendshapePresetValue))
                {
                ...
                if (characterSelected.ContainsKey(modularCustomizationManager.modularBlendShapes))
                {
                    modularCustomizationManager.UpdateBlendShapes((string)characterSelected[modularCustomizationManager.modularBlendShapes]);
                }
        ...
        protected void UpdateRaceDetails()
        {
            if (AtavismPrefabManager.Instance.GetRaceData().ContainsKey(raceId))
            {
                ...
                if (raceIcon != null)
                    raceIcon.sprite = AtavismPrefabManager.Instance.GetRaceIconByID(raceId);
                if (raceTitle != null)
        ...
        protected void UpdateClassDetails()
        {
            ...
            if (AtavismPrefabManager.Instance.GetRaceData().ContainsKey(raceId) && AtavismPrefabManager.Instance.GetRaceData()[raceId].classList.ContainsKey(aspectId))
            {
                ...
                if (classIcon != null)
                {
                   classIcon.sprite =AtavismPrefabManager.Instance.GetClassIconByID(raceId, aspectId);
                }
        ...
        public virtual void CreateCharacter()
        {
            ...
            if (PortraitManager.Instance.portraitType == PortraitType.Custom)
            {
                ...
                if (icons != null && icons.Length > 0)
                {
                    if (avatarList == null)
                    {
                        Debug.LogWarning("CharacterSelectionCreationManager avatarList is null", gameObject);
                    }
                    else
                    {
                        if (icons.Length > avatarList.Selected())
                            ...
                            {
                                Debug.LogWarning("CharacterSelectionCreationManager icons for " + raceName+" "+ganderName + " "+ className+" is null ; avatarList selected " + avatarList.Selected(), gameObject);
                            }
                            else
                            {
            ...
            if (modularCustomizationManager)
            {
                ...
                if (modularCustomizationManager.ActiveFaith != null || modularCustomizationManager.ActiveFaith != "")
                {
        ...
        void ResetModel()
        {
            ...
            if (modularCustomizationManager)
            {
                ...
                morphShapesManager = character.GetComponent<MorphShapesManager>();
                if (morphShapesManager)
                {

                    if(modularCharacterDnaPanel)
                        modularCharacterDnaPanel.CreateMorphShapeSliders(morphShapesManager);

                    if (modularCharacterHeadDnaPanel)
                        modularCharacterHeadDnaPanel.CreateMorphShapeSliders(morphShapesManager);
                }
                else
                {
                    if (modularCharacterDnaPanel)
                        modularCharacterDnaPanel.ClearExistingSliders();

                    if (modularCharacterHeadDnaPanel)
                        modularCharacterHeadDnaPanel.ClearExistingSliders();
                }
        ...
        public void SetReligon(string faith)
        {
            ...
            {
                Debug.LogError("no ModularCustomizationManager Component attached to the model ");
            }else  modularCustomizationManager.SetFaith(faith);
        ...
        public void SetBlendShapes()
        {
            ...
            {
                Debug.LogError("no ModularCustomizationManager Component attached to the model ");
            }else  modularCustomizationManager.SetMorphShapes();
               ...
               switch (modularCharacterSlider.dna)
                {
                   ...
                   /* case "Scar":
                    ...
                    case "BlendShape":
                        modularCharacterSlider.slider.onValueChanged.AddListener(id => {
                            MorphShapesManager morphShapesManager = character.GetComponent<MorphShapesManager>();
                            if (morphShapesManager)
                                morphShapesManager.UpdateMorphShapeValue(modularCharacterSlider.label.text, id, modularCharacterSlider.morphObjName);
                        });
                        break;
                   ...
                   // Debug.LogError("RegisterModularCharacterPicker "+modularCharacterColor.dna);
                    switch (modularCharacterColor.dna)
                    {
                        case "BodyArtColor":
                            ...
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultBodyArtColor);
                        ...
                        case "EyeColor":
                            if (modularCharacterColor.picker)
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultEyeColor);
                        ...
                        case "HairColor":
                            if (modularCharacterColor.picker)
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultHairColor);
                        ...
                        case "StubbleColor":
                            if (modularCharacterColor.picker)
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultStubbleColor);
                        ...
                        case "ScarColor":
                            if (modularCharacterColor.picker)
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultScarColor);
                        ...
                        case "MouthColor":
                            if (modularCharacterColor.picker)
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultMouthColor);
                        ...
                        case "SkinColor":
                            if (modularCharacterColor.picker)
                            {
                                modularCharacterColor.picker.AssignColor(modularCustomizationManager.defaultSkinColor);
